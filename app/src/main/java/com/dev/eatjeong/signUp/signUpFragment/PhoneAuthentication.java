...
public class PhoneAuthentication extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        remain_textview2 = v.findViewById(R.id.remain_textview2);
        apply_false_textview = v.findViewById(R.id.apply_false_textview);
        phone_number_text = v.findViewById(R.id.phone_number_text);
        authentication_response_layout = v.findViewById(R.id.authentication_response_layout);
        phone_number_edittext = v.findViewById(R.id.phone_number_edittext);
        imm = (InputMethodManager) getActivity().getSystemService(getActivity().INPUT_METHOD_SERVICE); //키보드 관련.


        progressDialog = new ProgressDialog(getContext());
        next_appCompatButton_true = v.findViewById(R.id.phone_next_appCompatButton_true);
        next_appCompatButton_false = v.findViewById(R.id.phone_next_appCompatButton_false);
        phone_number_apply_button_false = v.findViewById(R.id.phone_number_apply_button_false); //인증하기 버튼 비활성화
        phone_number_apply_button_true = v.findViewById(R.id.phone_number_apply_button_true); //인증하기 버튼 활성화
        phone_number_reapply_button = v.findViewById(R.id.phone_number_reapply_button); //재전송 버튼

        apply_number_edtitext = v.findViewById(R.id.apply_number_edtitext); //인증번호 기입 란
...
//                            System.out.println("인증한 유저 전화번호 : " + user.getPhoneNumber());
                            ...
                            ((SignUpActivity) Objects.requireNonNull(getActivity())).changeFragment("userInfoSetUp",phone_number_edittext.getText().toString() ,PhoneAuthentication.this);
                        } else {
