...
public class SearchNaverReviewWebviewActivity extends AppCompatActivity implements View.OnClickListener {
...
//                }
                ...
                bookmark_add.setOnClickListener(SearchNaverReviewWebviewActivity.this);
                bookmark_cancel.setOnClickListener(SearchNaverReviewWebviewActivity.this);

                author_black_add.setOnClickListener(SearchNaverReviewWebviewActivity.this);
                author_black_cancel.setOnClickListener(SearchNaverReviewWebviewActivity.this);

                post_black_add.setOnClickListener(SearchNaverReviewWebviewActivity.this);
                post_black_cancel.setOnClickListener(SearchNaverReviewWebviewActivity.this);
    ...
    public class BookmarkBlackListControll {
        ...
        Json을 우리가 원하는 형태로 만들어주는 Gson라이브러리와 Retrofit2에 연결하는 코드입니다 */
            ...
            callResponse(code_division);

        }

        private void callResponse(int code_division) {
            ...
            */
            ...
            if (code_division == 0) {
                mCallCommonMapResponseVO = mSearchRetrofitAPI.setBookmarkYoutube("naver", place_id, review_id, user_id, sns_division);
            } else if (code_division == 1) {
                mCallCommonMapResponseVO = mSearchRetrofitAPI.setBlackList(review_id,place_id, user_id, sns_division, "naver", author, "author");
            } else if (code_division == 2) {
                mCallCommonMapResponseVO = mSearchRetrofitAPI.setBlackList(review_id,place_id, user_id, sns_division, "naver", author, "post");
            } else if (code_division == 3) {
                mCallCommonMapResponseVO = mSearchRetrofitAPI.deleteBookmarkYoutube("naver", place_id, review_id, user_id, sns_division);
            } else if (code_division == 4) {
                mCallCommonMapResponseVO = mSearchRetrofitAPI.deleteBlackList(place_id,user_id, sns_division, "naver", author, "author", review_id);
            } else if (code_division == 5) {
                mCallCommonMapResponseVO = mSearchRetrofitAPI.deleteBlackList(place_id,user_id, sns_division, "naver", author, "post", review_id);
            }
