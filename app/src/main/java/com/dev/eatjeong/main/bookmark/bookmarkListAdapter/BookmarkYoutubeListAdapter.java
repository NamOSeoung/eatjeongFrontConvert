...
public class BookmarkYoutubeListAdapter extends BaseAdapter {
    private ArrayList<BookmarkReviewListVO> data;
    private Context context;
    private RequestManager mGlide;

    public BookmarkYoutubeListAdapter(Context context, ArrayList<BookmarkReviewListVO> data, RequestManager mGlideRequestManager) {
    ...
    @Override
    public BookmarkReviewListVO getItem(int position) {
