...
public class GoogleReviewListAdapter extends RecyclerView.Adapter<GoogleReviewListAdapter.Holder> {

    private Context context;
    private List<GoogleReviewVO> list = new ArrayList<>();

    public GoogleReviewListAdapter(Context context, List<GoogleReviewVO> list) {
    ...
    public Holder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.search_google_review_list_item, parent, false);
    ...
    public void onBindViewHolder(Holder holder, int position) {
        ...
        Log.e("GoogleReviewListAdapter", list.get(itemposition).toString());

        String rating_point = list.get(itemposition).getG_rating();
        holder.write_date.setText(list.get(itemposition).getWrite_date());
        holder.google_text_view.setText(list.get(itemposition).getG_content());

        if(rating_point.equals("1")){
            holder.star_y1.setImageResource(R.drawable.star_o_64);
            ...
            holder.star_y1.setImageResource(R.drawable.star_o_64);
            holder.star_y2.setImageResource(R.drawable.star_o_64);
            holder.star_y3.setImageResource(R.drawable.star_d_128);
            holder.star_y4.setImageResource(R.drawable.star_d_128);
            holder.star_y5.setImageResource(R.drawable.star_d_128);
            ...
            holder.star_y1.setImageResource(R.drawable.star_o_64);
            holder.star_y2.setImageResource(R.drawable.star_o_64);
            holder.star_y3.setImageResource(R.drawable.star_o_64);
            holder.star_y4.setImageResource(R.drawable.star_d_128);
            holder.star_y5.setImageResource(R.drawable.star_d_128);
            ...
            holder.star_y2.setImageResource(R.drawable.star_o_64);
            holder.star_y3.setImageResource(R.drawable.star_o_64);
            holder.star_y4.setImageResource(R.drawable.star_o_64);
            holder.star_y5.setImageResource(R.drawable.star_d_128);
            ...
            holder.star_y3.setImageResource(R.drawable.star_o_64);
            holder.star_y4.setImageResource(R.drawable.star_o_64);
            holder.star_y5.setImageResource(R.drawable.star_o_64);
        }
    }
