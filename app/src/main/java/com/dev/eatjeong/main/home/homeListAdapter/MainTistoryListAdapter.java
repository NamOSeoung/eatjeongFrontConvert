...
public class MainTistoryListAdapter extends RecyclerView.Adapter<MainTistoryListAdapter.Holder> {
    ...
    public MainTistoryListAdapter(Context context, List<MainReviewVO> list) {
    ...
    public Holder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.home_tistory_list_item, parent, false);
