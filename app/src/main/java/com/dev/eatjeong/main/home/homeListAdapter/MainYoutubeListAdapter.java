...
public class MainYoutubeListAdapter extends RecyclerView.Adapter<MainYoutubeListAdapter.Holder> {
    ...
    public MainYoutubeListAdapter(Context context, List<MainReviewVO> list) {
    ...
    public Holder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.home_youtube_list_item, parent, false);
