...
public class SettingsFaqListAdapter extends RecyclerView.Adapter<SettingsFaqListAdapter.Holder> {
    ...
    private List<SettingsFaqListResponseVO.DataList> list = new ArrayList<SettingsFaqListResponseVO.DataList>();

    public SettingsFaqListAdapter(Context context,
                                  List<SettingsFaqListResponseVO.DataList> list) {
    ...
    public void onBindViewHolder(Holder holder, int position) {
        ...
        holder.faq_subject.setText( "Q "+list.get(itemposition).getSubject());
    }
    ...
    public class Holder extends RecyclerView.ViewHolder {
        ...
        public AppCompatTextView faq_subject;


        public Holder(View view) {
            super(view);

            faq_subject = view.findViewById(R.id.faq_subject);
        }
    }
}