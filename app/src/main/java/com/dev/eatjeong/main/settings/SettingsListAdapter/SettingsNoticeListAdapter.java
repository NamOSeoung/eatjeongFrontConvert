...
public class SettingsNoticeListAdapter extends RecyclerView.Adapter<SettingsNoticeListAdapter.Holder> {
    ...
    private List<SettingsNoticeListResponseVO.DataList> list = new ArrayList<SettingsNoticeListResponseVO.DataList>();

    public SettingsNoticeListAdapter(Context context,
                                     List<SettingsNoticeListResponseVO.DataList> list) {
